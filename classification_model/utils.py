...
# todo add gap layers:https://blog.csdn.net/u012426298/article/details/81813963
def build_finetune_model(base_model, dropout, fc_layers, num_classes):
    ...
    if(False):
        ...
        gap_output=GlobalAveragePooling2D()(x)
        predictions = Dense(num_classes, activation='softmax')(gap_output) # New softmax layer
        finetune_model = Model(inputs=base_model.input, outputs=predictions)
