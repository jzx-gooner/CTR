...
input_folder = './debug/temp_uncertain/'
labels = ["BMW3", "BMW7","NONE"]
copy_or_move = 'move'
df_path = './debug/temp_uncertain/results.csv'
file_extensions = ['.jpg', '.png', '.JPG']
#####
...
class ImageGui:
    ...
    def __init__(self, master, labels, paths):
        ...
        self.buttons.append(tk.Button(frame, text="上一张", width=10, height=1, fg="green", command=lambda l=label: self.move_prev_image()))
        self.buttons.append(tk.Button(frame, text="下一张", width=10, height=1, fg='green', command=lambda l=label: self.move_next_image()))
        # Add progress label
        ...
        self.progress_label.grid(row=0, column=self.n_labels+2, sticky='we')    
        # Add sorting label
